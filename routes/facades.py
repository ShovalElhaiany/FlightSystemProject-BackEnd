...
def setup_facades_routes():
    ...
    base.add_url_rule('/flights/parameters', methods=['POST'], view_func=FacadeBase.get_flights_by_parameters)
    ...
    base.add_url_rule('/airlines/parameters', methods=['POST'], view_func=FacadeBase.get_airline_by_parameters)
    ...
    administrator.add_url_rule('/customers/<int:customer_id>', methods=['GET'], view_func=AdministratorFacade.get_customer)
    ...
    administrator.add_url_rule('/administrators/<int:admin_id>', methods=['GET'], view_func=AdministratorFacade.get_administrator)
    ...
    customer.add_url_rule('/tickets/<int:ticket_id>', methods=['GET'], view_func=CustomerFacade.get_ticket)
