...
# Searches Routes
        searche.add_url_rule('/flights/parameters', methods=['GET'], view_func=get_flights_by_parameters, endpoint='get_flights_by_parameters')
        searche.add_url_rule('/flights/airline/<int:airline_id>', methods=['GET'], view_func=get_flights_by_airline_id, endpoint='get_flights_by_airline_id')
        searche.add_url_rule('/flights/origin-country/<int:country_id>', methods=['GET'], view_func=get_flights_by_origin_country_id, endpoint='get_flights_by_origin_country_id')
        searche.add_url_rule('/flights/destination-country/<int:country_id>', methods=['GET'], view_func=get_flights_by_destination_country_id, endpoint='get_flights_by_destination_country_id')
        searche.add_url_rule('/flights/departure-date/<date>', methods=['GET'], view_func=get_flights_by_departure_date, endpoint='get_flights_by_departure_date')
        searche.add_url_rule('/flights/landing-date/<date>', methods=['GET'], view_func=get_flights_by_landing_date, endpoint='get_flights_by_landing_date')
        searche.add_url_rule('/flights/arrival-flights/<int:country_id>', methods=['GET'], view_func=get_arrival_flights, endpoint='get_arrival_flights')
        searche.add_url_rule('/flights/departure-flights/<int:country_id>', methods=['GET'], view_func=get_departure_flights, endpoint='get_departure_flights')
        searche.add_url_rule('/airlines/username/<username>', methods=['GET'], view_func=get_airline_by_username, endpoint='get_airline_by_username')
        searche.add_url_rule('/airlines/country/<int:country_id>', methods=['GET'], view_func=get_airlines_by_country, endpoint='get_airlines_by_country')
        searche.add_url_rule('/users/username/<username>', methods=['GET'], view_func=get_user_by_username, endpoint='get_user_by_username')
        searche.add_url_rule('/tickets/customer/<int:customer_id>', methods=['GET'], view_func=get_tickets_by_customer, endpoint='get_tickets_by_customer')
        searche.add_url_rule('/customers/username/<username>', methods=['GET'], view_func=get_customer_by_username, endpoint='get_customer_by_username')
        # searche.add_url_rule('flights/customer/<int:customer_id>', methods=['GET'], view_func=get_flights_by_customer, endpoint='get_flights_by_customer')
        searche.add_url_rule('/airlines/parameters', methods=['GET'], view_func=get_airlines_by_parameters, endpoint='get_airlines_by_parameters')
...
# # customerFacade
#         facade.add_url_rule('/customers/<int:customer_id>', methods=['PUT'], view_func=update_customer)
#         facade.add_url_rule('/tickets', methods=['POST'], view_func=add_ticket)
#         facade.add_url_rule('/tickets/<int:ticket_id>', methods=['DELETE'], view_func=remove_ticket)
#         facade.add_url_rule('/mytickets', methods=['GET'], view_func=get_my_tickets)